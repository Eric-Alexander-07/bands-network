...
/* Anders als bei We Rock gibt es hier keine Rueckfallliste mit echten Fotos:
   die Namen "Bobby" und "Kai" sind von der Bandwebsite bestaetigt, aber ohne
   zuordenbares Foto — deshalb bleibt die Liste leer, bis echte Musiker ueber
   den Admin gepflegt sind (siehe FALLBACK_SINGERS = [] unten). */
...
export default function SingerCarousel({ title, members = [] }: Props) {
  ...
  // Weder Datenbank noch Rueckfallliste haben Musiker — Abschnitt ausblenden,
  // statt eine leere Karussell-Huelle zu zeigen.
