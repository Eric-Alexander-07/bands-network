    ...
    <>
      <nav className={`nav${scrolled ? " scrolled" : ""}${mobileOpen ? " nav-open" : ""}`}>
        ...
        <div className="container nav-inner">
          {/* Noch kein eigenes Logo vorhanden — anders als bei We Rock zeigt die
              Navigation auf allen Seiten den Bandnamen als Text, nicht nur auf
              der Startseite. Sobald ein Logo geliefert wird, hier die
              urspruengliche Bild-Variante fuer Unterseiten zurueckbringen. */}
