...
const FALLBACK_PHOTOS = [
  { src: "/images/party-1.webp", alt: "BOBbastic – Live-Auftritt" },
  { src: "/images/party-2.webp", alt: "BOBbastic – Live-Auftritt" },
  { src: "/images/party-3.webp", alt: "BOBbastic – Live-Auftritt" },
];
