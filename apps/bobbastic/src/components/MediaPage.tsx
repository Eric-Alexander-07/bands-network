...
const PLATFORMS = [
  { key: "instagram" as const, label: "Instagram", handle: "@bobbastic_band" },
  { key: "facebook"  as const, label: "Facebook",  handle: "BOBBASTIC" },
  // Kein bestaetigtes @-Handle bekannt (Kanal-URL statt Custom-Handle) —
  // Bandname statt erfundenem Handle anzeigen.
  { key: "youtube"   as const, label: "YouTube",   handle: "BOBBASTIC" },
];
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <div className="media-main-layout">
            ...
            <div className="media-videos-col">
              ...
              {/* Featured — nur wenn mindestens ein Video gepflegt ist. Anders
                  als bei We Rock (immer mind. ein Fallback-Video) hat
                  BOBbastic noch keine bestaetigten Video-Links, `mainVideo`
                  waere sonst `undefined` und die Seite wuerde abstuerzen. */}
              {mainVideo && (
