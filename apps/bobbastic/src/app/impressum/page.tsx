...
const IMPRESSUM_DESCRIPTION =
  "Impressum von BOBbastic – Vivid Music Productions, Bernhard Stöcker, Westring 20, 64823 Groß-Umstadt.";

export const metadata: Metadata = {
  title: "Impressum – BOBbastic",
  description: IMPRESSUM_DESCRIPTION,

  alternates: { canonical: "https://bobbastic.de/impressum" },
  openGraph: {
    title: "Impressum – BOBbastic",
    description: IMPRESSUM_DESCRIPTION,
    url: "https://bobbastic.de/impressum",
