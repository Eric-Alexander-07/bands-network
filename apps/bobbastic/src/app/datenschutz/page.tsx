...
const DATENSCHUTZ_DESCRIPTION =
  "Datenschutzerklärung von BOBbastic – Vivid Music Productions. Informationen zur Verarbeitung personenbezogener Daten.";

export const metadata: Metadata = {
  title: "Datenschutz – BOBbastic",
  description: DATENSCHUTZ_DESCRIPTION,

  alternates: { canonical: "https://bobbastic.de/datenschutz" },
  openGraph: {
    title: "Datenschutz – BOBbastic",
    description: DATENSCHUTZ_DESCRIPTION,
    url: "https://bobbastic.de/datenschutz",
        ...
        <div className="container">
          <div className="legal-content">
            ...
            <div className="legal-block">
              ...
              <p>
                Diese Website enthält Links zu den externen Profilen von BOBbastic bei Instagram,
