...
/**
 * Nur Profile anzeigen, die tatsaechlich gepflegt sind — Bobby & Friends
 * Unplugged hat bisher nur Instagram. Fehlende Plattformen erzeugen sonst
 * tote Links.
 */
...
export default function SocialSection({ c }: { c: Content }) {
  return (
    <section className="section social-media-section section-has-rings">
      <SoundWaves variant="cluster" origin={{ x: 1.05, y: 0.5 }} spread={0.9} intensity={0.3} />
