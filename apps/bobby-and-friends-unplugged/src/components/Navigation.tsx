    ...
    <>
      <nav className={`nav${scrolled ? " scrolled" : ""}${mobileOpen ? " nav-open" : ""}`}>
        ...
        <div className="container nav-inner">
          {/* Kein gestaltetes Logo vorhanden — anders als bei Groove Control
              (eigenes Wortmarken-Bild) traegt hier der reine Bandname die
              Navigation, wie bei Spirit of Soul und We Rock. */}
