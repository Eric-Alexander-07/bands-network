...
export default function HeroSection({ dbEvents = [], c }: Props) {
  // Zeile 1 normal, Zeile 2 kursiv — wie bei Spirit of Soul und We Rock.
    ...
    <section className="hero">
      <div className="hero-split">
        <div className="hero-left">
          <SoundWaves variant="cluster" origin={{ x: 1, y: 0.5 }} spread={0.85} seed={3} intensity={0.22} />
          <div className="hero-content">
            <p className="hero-eyebrow">{c.hero_eyebrow}</p>
            {/* Kein gestaltetes Logo vorhanden (anders als Groove Control) —
                die Ueberschrift traegt Text, Zeile 1 normal, Zeile 2 kursiv,
                wie bei Spirit of Soul und We Rock. */}
          ...
          <div ref={parallaxRef} className="hero-right-inner">
            {c.hero_image ? (
              <picture>
                ...
                <img
                  src={c.hero_image}
                  alt="Bobby & Friends Unplugged — Live"
              ...
              <div className="hero-right-placeholder">
                <img src="/images/placeholder.svg" alt="Bobby & Friends Unplugged" />
              </div>
            )}
          </div>
        </div>
