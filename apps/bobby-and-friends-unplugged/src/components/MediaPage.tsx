...
/** Aus einer Profil-URL den anzeigbaren Namen ableiten (z. B. @bobbyandfriends_band). */
          ...
          <div className="media-social-inner">
            ...
            <div className="media-social-content">
              ...
              {/* Das Facebook-Page-Plugin erscheint nur, wenn eine Facebook-Seite
                  gepflegt ist — Bobby & Friends Unplugged hat bisher keine. */}
              {facebookUrl && (
                <div className="media-fb-inline" data-animate="fade-up">
                  <iframe
                    ...
                    title="Bobby & Friends Unplugged auf Facebook"
                  />
                </div>
              )}
