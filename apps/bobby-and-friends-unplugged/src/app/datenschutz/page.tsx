...
const DESCRIPTION =
  "Datenschutzerklärung von Bobby & Friends Unplugged. Informationen zur Verarbeitung personenbezogener Daten auf dieser Website.";

export const metadata: Metadata = {
  title: { absolute: "Datenschutz – Bobby & Friends Unplugged" },
  description: DESCRIPTION,
  alternates: { canonical: "https://bobbyandfriends-unplugged.de/datenschutz" },
  openGraph: {
    title: "Datenschutz – Bobby & Friends Unplugged",
    description: DESCRIPTION,
    url: "https://bobbyandfriends-unplugged.de/datenschutz",
        ...
        <div className="container">
          <div className="legal-content">
            ...
            <div className="legal-block">
              ...
              <p>
                Diese Website enthält Links zu den externen Profilen von Bobby & Friends Unplugged
                bei Instagram. Durch das Anklicken dieser Links verlassen Sie unsere
