...
const DESCRIPTION =
  "Impressum von Bobby & Friends Unplugged. Vivid Music Productions, Bernhard Stöcker, Westring 20, 64823 Groß-Umstadt.";

export const metadata: Metadata = {
  title: { absolute: "Impressum – Bobby & Friends Unplugged" },
  description: DESCRIPTION,
  alternates: { canonical: "https://bobbyandfriends-unplugged.de/impressum" },
  openGraph: {
    title: "Impressum – Bobby & Friends Unplugged",
    description: DESCRIPTION,
    url: "https://bobbyandfriends-unplugged.de/impressum",
          ...
          <div className="legal-content">
            ...
            <div className="legal-block">
              ...
              <p>
                ...
                Fax: +49 6078 759569<br />
                Mobil: +49 177 5719570<br />
