/**
 * Inhaltsschema fuer BOBBY & FRIENDS UNPLUGGED.
 *
 ...
 *
 * Inhalte stammen von v-m-p.com/bobby-and-friends (das eigentliche
 * "Unplugged"-Profil) und ergaenzend von info080059.wixsite.com/bobbyandfriends
 * (aeltere, breiter angelegte Bandwebsite unter dem Namen "Bobby & Friends"
 * ohne Unplugged-Zusatz — dieselbe Person, Bobby Stöcker, dieselbe Historie).
 *
 * BILDER: Alle Bildfelder zeigen auf echte Fotos aus dem VMP-Bilderpool der
 * Band (Storage-Ordner `bobby-and-friends-unplugged/galerie/`), aufbereitet
 * unter `public/images`.
 *
 * TON: Bobby & Friends Unplugged siezt („Ihr Event", „Fragen Sie an"), wie
 * Groove Control und The Adams Family.
 *
 * KEIN GESTALTETES LOGO: Anders als Groove Control gibt es kein Logo-Bild —
 * deshalb gibt es hier (anders als bei Groove Control/Adams Family) wieder
 * ein `hero_title`-Feld: Zeile 1 normal, Zeile 2 kursiv, wie bei Spirit of
 * Soul und We Rock.
 */

import type { SiteContentSchema } from "@bands/content";

const BAND_NAME = "Bobby & Friends Unplugged";
      ...
      groups: [
        {
          ...
          fields: [
            ...
            { key: "band_claim", label: "Claim", type: "text",
              default: "Handgemachte Akustikmusik für Wohnzimmerkonzerte und Dinner" },
            { key: "band_genre", label: "Genre", type: "text", default: "Unplugged / Akustik / Singer-Songwriter" },
      ...
      groups: [
        {
          ...
          fields: [
            { key: "hero_eyebrow", label: "Kleiner Text ueber dem Titel", type: "text",
              default: "Unplugged · Solo bis Sextett" },
            { key: "hero_title", label: "Grosse Ueberschrift", type: "textarea", rows: 2,
              default: "Bobby & Friends\nUnplugged",
              help: "Zwei Zeilen. Die zweite Zeile wird kursiv dargestellt." },
            { key: "hero_claim", label: "Claim", type: "text",
              default: "Handgemachte Akustikmusik für Ihr Wohnzimmerkonzert" },
            { key: "hero_sub", label: "Unterzeile", type: "text",
              default: "Gitarre und Gesang von Bobby Stöcker — seit vier Jahrzehnten auf der Bühne." },
        ...
        },
        {
          ...
          fields: [
            ...
            { key: "occasions_text", label: "Text", type: "textarea", rows: 5,
              default: "Ob Wohnzimmerkonzert, Dinner, Hochzeit oder Firmenempfang: Bobby & Friends Unplugged passt sich Ihrem Rahmen an — von der Soloakustik bis zur erweiterten Besetzung." },
          ],
        },
        {
          title: "Buchungs-CTA",
          ...
          fields: [
            { key: "cta_title", label: "Ueberschrift", type: "text",
              default: "Livemusik zum Anfassen für Ihren Anlass" },
            { key: "cta_text", label: "Text", type: "textarea", rows: 3,
              default: "Wohnzimmerkonzert, Dinner oder Hochzeit — wir stellen das passende Programm für Ihren Abend zusammen." },
          ],
        },
      ],
      lists: [
      ...
      groups: [
        {
          ...
          fields: [
            ...
            { key: "text_top", label: "Text im Seitenkopf", type: "textarea", rows: 4,
              default: "100 % live, 100 % handgemacht. Bobby Stöcker steht seit vier Jahrzehnten auf der Bühne — reduziert auf Gitarre und Gesang, nach dem Motto „Weniger ist mehr“." },
          ],
        },
        {
          ...
          fields: [
            ...
            { key: "text_bottom", label: "Text", type: "textarea", rows: 8,
              default: "Bobby Stöcker begann mit fünf Jahren am Klavier und wechselte mit zwölf Jahren zur Gitarre. Mit sechzehn gründete er seine erste Band und schreibt seitdem eigene Songs.\nEr spielte gemeinsam mit Bobby Kimball (Sänger von TOTO) und dem Bassisten Martin Engelien, stand als Lead-Gitarrist im Musical „Tommy“ von The Who im Offenbacher Capitol auf der Bühne und schrieb Songs für Künstler wie Melanie Thornton (La Bouche).\nHeute präsentiert er „Unplugged Klassiker“ aus vier Jahrzehnten — umarrangiert und mit einem gehörigen Schuss Lagerfeuer-Atmosphäre, ganz nach dem Motto „Weniger ist mehr“.",
      ...
      groups: [
        {
          ...
          fields: [
            ...
            { key: "text_top", label: "Text im Seitenkopf", type: "textarea", rows: 3,
              default: "Von der Soloakustik bis zur erweiterten Bandbesetzung — Bobby & Friends Unplugged bringt die passende Musik für jeden Teil des Abends." },
          ],
        },
        {
          title: "Besetzung",
          ...
          fields: [
            ...
            { key: "besetzung_text", label: "Einleitung", type: "textarea", rows: 4,
              default: "Bobby & Friends Unplugged ist in verschiedenen Besetzungen buchbar — vom Solo-Auftritt mit Gitarre und Gesang bis zur erweiterten Band für größere Feiern." },
          ],
        },
        {
          title: "Technik",
          fields: [
            ...
            { key: "technik_text", label: "Text", type: "textarea", rows: 5,
              default: "Auf Wunsch bringen wir das komplette Setup mit — von PA und Monitoring bis zu Licht. Erfahrene Technik sorgt dafür, dass der Sound im Raum sitzt." },
            { key: "technik_note", label: "Hinweis darunter", type: "textarea", rows: 3,
              default: "Gerne erstellen wir Ihnen ein Paketangebot über Musiker, Technik und Ablauf inklusive persönlicher Betreuung." },
          ],
        },
        {
          title: "Buchungs-CTA",
          fields: [
            ...
            { key: "cta_text", label: "Text", type: "textarea", rows: 3,
              default: "Wir erstellen gerne ein maßgeschneidertes Angebot für Ihre Veranstaltung — inklusive Besetzung und Technik." },
          ],
        },
      ],
      lists: [
      ...
      groups: [
        {
          ...
          fields: [
            ...
            { key: "text_top", label: "Text im Seitenkopf", type: "textarea", rows: 3,
              default: "Aktuelle Videos, Auftritte und Neuigkeiten von Bobby & Friends Unplugged." },
          ],
        },
        {
          title: "Videos",
      ...
      groups: [
        {
          ...
          fields: [
            ...
            { key: "page_hero_text", label: "Text im Seitenkopf", type: "textarea", rows: 2,
              default: "Impressionen von Wohnzimmerkonzerten, Dinnerabenden und Hochzeiten." },
          ],
        },
        {
          title: "Fotoraster",
        ...
        },
        {
          ...
          fields: [
            ...
            { key: "referenzen_text", label: "Text", type: "textarea", rows: 3,
              default: "Eine Auswahl der Unternehmen und privaten Feiern, die Bobby & Friends Unplugged für ihre Events gebucht haben." },
          ],
        },
        {
          ...
          fields: [
            ...
            { key: "partner_vmp_text", label: "Hinweiskasten VMP", type: "textarea", rows: 4,
              default: "Bobby & Friends Unplugged ist Teil des **Vivid Music Productions** Künstlerpools – einem Netzwerk aus Profibands, Musikern und Medienschaffenden für Events jeder Größe.",
    ...
    // ─────────────────────────────────────────────────────────────
    {
      ...
      groups: [
        ...
        },
        {
          title: "Kontaktspalte",
          fields: [
            { key: "booking_title", label: "Ueberschrift", type: "text", default: "Bobby & Friends Unplugged anfragen" },
        ...
        },
        {
          ...
          fields: [
            ...
            { key: "booking_checklist_first", label: "Erster Punkt", type: "text",
              default: "Bitte geben Sie im Betreff den Namen der Band an: **Bobby & Friends Unplugged**.",
              help: "Text zwischen **doppelten Sternchen** wird fett dargestellt." },
          ],
        },
        {
