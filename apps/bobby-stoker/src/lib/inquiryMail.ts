...
/**
 * Buchungsanfrage per E-Mail — Bobby Stoker Band.
 *
 * Die Band siezt. Die Fragen sind allgemein auf eine Live-Buchung zugeschnitten
 * (Buehne, Technik, Spieldauer, weitere Kuenstler) — analog zu den anderen
 * VMP-Bandwebsites.
 *
