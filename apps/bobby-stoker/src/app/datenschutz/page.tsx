...
const DESCRIPTION =
  "Datenschutzerklärung der Bobby Stoker Band. Informationen zur Verarbeitung personenbezogener Daten auf dieser Website.";
...
export const metadata: Metadata = {
  ...
  title: { absolute: "Datenschutz – Bobby Stoker Band" },
  description: DESCRIPTION,
  alternates: { canonical: "https://bobbystoker.com/datenschutz" },
  openGraph: {
    title: "Datenschutz – Bobby Stoker Band",
    description: DESCRIPTION,
    url: "https://bobbystoker.com/datenschutz",
        ...
        <div className="container">
          <div className="legal-content">
            ...
            <div className="legal-block">
              ...
              <p>
                Diese Website enthält Links zu den externen Profilen der Bobby Stoker Band bei
