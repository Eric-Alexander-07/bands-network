...
const DESCRIPTION =
  "Impressum der Bobby Stoker Band. Vivid Music Productions, Bernhard Stöcker, Westring 20, 64823 Groß-Umstadt.";
...
export const metadata: Metadata = {
  ...
  title: { absolute: "Impressum – Bobby Stoker Band" },
  description: DESCRIPTION,
  alternates: { canonical: "https://bobbystoker.com/impressum" },
  openGraph: {
    title: "Impressum – Bobby Stoker Band",
    description: DESCRIPTION,
    url: "https://bobbystoker.com/impressum",
