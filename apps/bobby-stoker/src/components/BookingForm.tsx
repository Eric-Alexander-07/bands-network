    ...
    <div className="booking-layout">
      ...
      {submitted ? (
        <div className="form-success">
          <p className="form-success-title">{c.booking_success_title}</p>
          <p className="form-success-sub">{c.booking_success_text}</p>
        </div>
      ) : (
        <form className="form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="occasion">
              {c.booking_form_occasion_label}
            </label>
            <select id="occasion" name="occasion" className="form-select">
              <option value="">{c.booking_form_occasion_placeholder}</option>
          ...
          <div>
            <button
              ...
              disabled={sending}
            >
              {sending ? "Wird gesendet …" : c.booking_form_submit}
            </button>
          </div>
        </form>
      )}
