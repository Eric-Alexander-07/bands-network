...
const FALLBACK_PHOTOS = [
  { src: "/images/services-hero.webp", alt: "Bobby Stoker Band auf der Bühne" },
  { src: "/images/referenzen-header.webp", alt: "Bobby Stoker Band beim Fototermin" },
  { src: "/images/kontakt-hero.webp", alt: "Bobby Stoker live an der Gitarre" },
];
