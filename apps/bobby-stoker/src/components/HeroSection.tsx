    ...
    <section className="hero">
      <div className="hero-split">
        <div className="hero-left">
          <StageRays className="rays-hero" />
          <div className="hero-content">
            <p className="hero-eyebrow">{c.hero_eyebrow}</p>
            {/* Kein Bandlogo vorhanden — anders als bei den anderen Bands traegt
                hier eine Wortmarke in der Displayschrift die Headline. */}
            <h1 className="hero-title">
              <span className="hero-wordmark">{band.name}</span>
            </h1>
          ...
          <div ref={parallaxRef} className="hero-right-inner">
            {c.hero_image ? (
              ...
              <div className="hero-right-placeholder">
                <span className="hero-wordmark hero-wordmark--placeholder">{band.name}</span>
              </div>
            )}
          </div>
        </div>
