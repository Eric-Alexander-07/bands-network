...
/** Aus einer Profil-URL den anzeigbaren Namen ableiten (z. B. @theadamsfamily_band). */
    ...
    <>
      ...
      <section className="section section-has-rings">
        ...
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <div className={`media-main-layout${showEvents.length === 0 ? " media-main-layout--solo" : ""}`}>
          ...
          <div className="media-social-inner">
            ...
            <div className="media-social-content">
              ...
              {/* Das Facebook-Page-Plugin erscheint nur, wenn eine Facebook-Seite
                  gepflegt ist — The Adams Family hat bisher keine. */}
              {facebookUrl && (
                <div className="media-fb-inline" data-animate="fade-up">
                  <iframe
                    ...
                    title="The Adams Family auf Facebook"
                  />
                </div>
              )}
