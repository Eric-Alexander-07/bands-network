...
const FALLBACK_PHOTOS = [
  { src: "/images/services-hero.webp", alt: "The Adams Family auf der Bühne" },
  { src: "/images/referenzen-header.webp", alt: "Publikum bei einem Open-Air-Auftritt" },
  { src: "/images/kontakt-hero.webp", alt: "Akustisches Unplugged-Set" },
];
