...
const DESCRIPTION =
  "Impressum von The Adams Family. Vivid Music Productions, Bernhard Stöcker, Westring 20, 64823 Groß-Umstadt.";
...
export const metadata: Metadata = {
  ...
  title: { absolute: "Impressum – The Adams Family" },
  description: DESCRIPTION,
  alternates: { canonical: "https://theadamsfamily.de/impressum" },
  openGraph: {
    title: "Impressum – The Adams Family",
    description: DESCRIPTION,
    url: "https://theadamsfamily.de/impressum",
