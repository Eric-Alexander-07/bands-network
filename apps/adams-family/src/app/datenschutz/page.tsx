...
const DESCRIPTION =
  "Datenschutzerklärung von The Adams Family. Informationen zur Verarbeitung personenbezogener Daten auf dieser Website.";
...
export const metadata: Metadata = {
  ...
  title: { absolute: "Datenschutz – The Adams Family" },
  description: DESCRIPTION,
  alternates: { canonical: "https://theadamsfamily.de/datenschutz" },
  openGraph: {
    title: "Datenschutz – The Adams Family",
    description: DESCRIPTION,
    url: "https://theadamsfamily.de/datenschutz",
        ...
        <div className="container">
          <div className="legal-content">
            ...
            <div className="legal-block">
              ...
              <p>
                Diese Website enthält Links zu den externen Profilen von The Adams Family bei
