  ...
  return (
    <>
      ...
      <section className="section section-has-rings">
        <DotGrid variant="cluster" origin={{ x: 1.06, y: 0.18 }} spread={0.8} seed={1} intensity={0.22} />
        <div className="container" style={{ position: "relative", zIndex: 1 }}>
          <div className="about-simple-layout">
            <div className="about-simple-img" data-animate="fade-right">
              <img src={c.image_main} alt="Groove Control — Live" />
            </div>
            <div className="about-simple-text" data-animate="fade-left">
              <span className="eyebrow">Partyband Deluxe</span>
              <h2>{c.about_title}</h2>
