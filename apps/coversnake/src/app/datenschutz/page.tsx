...
const DESCRIPTION =
  "Datenschutzerklärung von CoverSnake. Informationen zur Verarbeitung personenbezogener Daten auf dieser Website.";
...
export const metadata: Metadata = {
  ...
  title: { absolute: "Datenschutz – CoverSnake" },
  description: DESCRIPTION,
  alternates: { canonical: "https://coversnake.com/datenschutz" },
  openGraph: {
    title: "Datenschutz – CoverSnake",
    description: DESCRIPTION,
    url: "https://coversnake.com/datenschutz",
        ...
        <div className="container">
          <div className="legal-content">
            ...
            <div className="legal-block">
              ...
              <p>
                Diese Website enthält Links zu den externen Profilen von CoverSnake bei
