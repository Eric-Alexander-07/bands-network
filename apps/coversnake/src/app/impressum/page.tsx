...
const DESCRIPTION =
  "Impressum von CoverSnake. Vivid Music Productions, Bernhard Stöcker, Westring 20, 64823 Groß-Umstadt.";
...
export const metadata: Metadata = {
  ...
  title: { absolute: "Impressum – CoverSnake" },
  description: DESCRIPTION,
  alternates: { canonical: "https://coversnake.com/impressum" },
  openGraph: {
    title: "Impressum – CoverSnake",
    description: DESCRIPTION,
    url: "https://coversnake.com/impressum",
